 ...
 *
 * https://github.com/Emagister/zend-form-decorators-bootstrap/blob/master/Twitter/Bootstrap/Form.php
 * 
 * @category Forms
 * @package Twitter
 ...
 * @author Christian Soronellas <csoronellas@emagister.com>
 */
abstract class Twitter_Bootstrap_Form extends Cfe_Form {
    ...
    protected function _initializeFieldColSize() {
        foreach ($this->getElements() as $element) {
            if (!$element instanceof Zend_Form_Element_Submit and !$element instanceof Zend_Form_Element_Button and !$element instanceof Zend_Form_Element_Image and !$element instanceof Zend_Form_Element_Checkbox and !$element instanceof Zend_Form_Element_MultiCheckbox and !$element instanceof Zend_Form_Element_Radio) {
