...
class TeraWurflConfig{
	 ...
	 * @var String
	 */
	public static $DB_PASS = 'RDsr3fvJPZjZF73Y';
	/**
	 ...
	 * @var String
	 */
	public static $WURFL_DL_URL = "http://sourceforge.net/projects/wurfl/files/WURFL%20Database/1.4.4/wurfl-dbapi-1.4.4.0.zip";
	/**
