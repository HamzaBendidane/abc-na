...
class TeraWurfl{
	...
	/* public function getAllDeviceCapabilities(){
		...
		$i = 0;
		foreach ($this->devices as $devicesgroup){
			 
					if(isset($devicesgroup['product_info']['marketing_name'])){
						
						$all[] = $devicesgroup['product_info']['marketing_name'];
